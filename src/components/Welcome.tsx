...
export const Welcome = ({ onExampleClick }: WelcomeProps) => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-4 py-8 mt-16 animate-fade-up">
      <h1 className="mb-8 text-2xl sm:text-4xl bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-blue-600">
        Llama
      </h1>
      
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-4xl">
        <div className="flex flex-col items-center gap-3 card-hover p-4 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl">
